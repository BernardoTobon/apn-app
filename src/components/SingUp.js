        ...
        <div className="bg-dark-green bg-opacity-50">
          <form>
            <div className="flex justify-center py-8">
              <h1 className="font-extrabold text-2xl font-russo-one ">
                Nuevo Usuario
              </h1>
            </div>
            <div className="grid grid-cols-1  md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col p-8 border-solid ">
                ...
                <input
                  className="text-center border-2 border-black rounded-full text-center"
                  type="email"
                  required
                />
              </div>
              ...
              <div className="flex flex-col p-8 border-solid ">
                ...
                <select className="border-2 border-black rounded-full text-center">
            ...
            <div className="flex justify-center">
              <button
                className="m-2 bg-dark-green rounded-full w-[25vw]"
                type="submit"
              >
                AGREGAR
              </button>
