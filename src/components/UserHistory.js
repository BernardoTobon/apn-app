...
const HistoryUser = () => {
    ...
    <UserTabs>
        <div className="flex items-center flex-col">
            <h1 className="flex justify-center m-3 flex justify-center font-extrabold  text-transparent text-2xl bg-clip-text bg-gradient-to-r from-light-brown to-dark-green">Historia Clinica</h1>
           <form>
